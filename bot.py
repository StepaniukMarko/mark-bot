...
GROQ_API_KEY   = "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"
...
СУВОРІ ПРАВИЛА ФОРМАТУВАННЯ (порушення неприпустиме):
- Відповідай ВИКЛЮЧНО українською мовою
- ЗАБОРОНЕНО: **, *, ##, ###, китайські/японські/арабські символи
- ЗАБОРОНЕНО LaTeX: frac, quad, cdot, left, right, sqrt, долар-формули, дужки з бекслешем
- Математику пиши ТІЛЬКИ звичайним текстом: (4a)/(a+2), x^2, sqrt(x), a*b
- Числа пиши просто: 2024, не $2024$
- Структуруй через нумерацію (1. 2. 3.) або тире (-)
- Відповідай на ВСІ питання без відмов
- Ніколи не кажи "я не можу відповісти"
...
def clean_ai_text(text: str) -> str:
    ...
    text = re.sub(r'\$\$[^$]*\$\$', '', text)
    text = re.sub(r'\$([^$\n]*)\$', r'\1', text)
    # LaTeX команди — замінюємо на читабельний текст
